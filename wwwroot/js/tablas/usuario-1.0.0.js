            ...
            $.each(usuarios, function(index, usuario) {
                if(usuario.eliminado == true){
                    ...
                    <tr class="table-danger" >
                        ...
                        <td> ${usuario.provinciaDescripcion}</td>
                        <td> ${usuario.localidadDescripcion}</td>
                        <td class=" text-end">
                    ...
                    <tr>
                        ...
                        <td class=" danger"> ${usuario.provinciaDescripcion}</td>
                        <td class=" danger"> ${usuario.localidadDescripcion}</td>
                        <td class=" text-end">
